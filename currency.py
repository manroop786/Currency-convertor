...
headlabel = tk.Label(Tops,font=('lato black', 19,'bold'), text = '             Yuvraj & Kalash   :    Currency Converter  ', bg= '#663300',fg='white',justify='center') 
...
Label_9 =Button(root, font=('arial', 15,'bold'), text="   Clear All  ",padx=2,pady=2, bg="black",fg = "red",command=clear_all)
